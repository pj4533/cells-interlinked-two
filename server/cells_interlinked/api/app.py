...
from ..pipeline.interlink import InterlinkController
from ..storage import db
from .routes_autoresearch_dmt import router as autoresearch_dmt_router
from .routes_chat import router as chat_router
from .routes_interlink import router as interlink_router
...
async def lifespan(app: FastAPI):
    ...
    # Interlink (model-to-model auto-conversation). Mutually exclusive with the
    # autoresearch hunt + manual chat/trip (one heavy job at a time on the one M).
    app.state.interlink = InterlinkController(app)
    app.state.interlink_active = False
    ...
    try:
        ...
        if app.state.interlink.running:
            await app.state.interlink.stop()
...
def create_app() -> FastAPI:
    ...
    app.include_router(interlink_router)
